...
function seed() {
  ...
  tables.products = [
    { id: 'PRD-1', company_slug: 'ninefish', category: 'Frescos', name: 'Salmão Fresco Premium', code: 'USF-1', short: 'Filé selecionado, captura responsável.', long: 'Filé de salmão fresco selecionado, sem espinhas, gordura nobre marmorizada.', units_per_box: 6, origin: 'Chile', active: true, shared_with: [], images: ['https://www.dropbox.com/scl/fi/z0obo0egv8mzfeq20h18z/1778265131147_z90ns.png?rlkey=4v20vrrekwk8srqo6th0ckoa5&raw=1'], created_at: '2026-04-28' },
    { id: 'PRD-2', company_slug: 'ninefish', category: 'Congelados', name: 'Atum Yellowfin Saku', code: 'USF-2', short: 'Bloco premium para sashimi.', long: 'Bloco de atum yellowfin congelado a bordo, padrão exportação.', units_per_box: 12, origin: 'Brasil', active: true, shared_with: [], images: ['https://www.dropbox.com/scl/fi/tb3ibwuz9rpp52d2ys7sl/1778265186323_ifbrc.png?rlkey=qbks5n2zugglfisoox4m2q4wx&raw=1'], created_at: '2026-05-01' },
    { id: 'PRD-3', company_slug: 'ninefish', category: 'Defumados', name: 'Salmão Defumado a Frio', code: 'USF-3', short: 'Defumação artesanal lenta.', long: 'Defumação a frio com madeira nobre, fatiado fino, embalagem a vácuo.', units_per_box: 24, origin: 'Noruega', active: true, shared_with: [], images: ['https://www.dropbox.com/scl/fi/yvvjm1u3ba9661mzf2jl6/1778265230699_ptd68.png?rlkey=raosthjndszoy7zcywow7egl7&raw=1'], created_at: '2026-04-12' },
  ];
}
